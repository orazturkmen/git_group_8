...
public class IntersectionOfTwoLL {
    public static void main(String[] args) {
        ...
        Stream.of(1,2,3,4,5).forEach(list1::add);
        list1.head.print();

        MyLinkedList list2 = new MyLinkedList();
        Stream.of(6,7,8).forEach(list2::add);
        list2.tail.next = list1.head.next.next.next;
        list2.head.print();

        System.out.println(intersection(list1, list2).val);
    }

    public static Node intersection(MyLinkedList list1, MyLinkedList list2){
...
and skipB can be arbitrary values. The two lists do not intersect, so return null.
Constraints:
